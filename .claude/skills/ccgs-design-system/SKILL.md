...
- Read `refs/technical-preferences.md (bundled with this skill)` to identify the engine and version
...
Before finalizing the GDD, spawn `creative-director` via Task using gate **CD-GDD-ALIGN** (`refs/director-gates.md (bundled with this skill)`).
