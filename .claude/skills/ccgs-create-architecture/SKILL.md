...
3. `refs/technical-preferences.md (bundled with this skill)` — naming conventions, performance budgets,
...
Apply gate **TD-ARCHITECTURE** (`refs/director-gates.md (bundled with this skill)`) as a self-review. Check all four criteria from that gate definition against the completed document.
...
**Step 2 — Spawn `lead-programmer` via Task using gate LP-FEASIBILITY (`refs/director-gates.md (bundled with this skill)`):**
