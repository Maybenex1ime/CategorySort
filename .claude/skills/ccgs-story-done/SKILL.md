...
After completing the deviation checks in Phase 4, spawn `qa-lead` via Task using gate **QL-TEST-COVERAGE** (`refs/director-gates.md (bundled with this skill)`).
...
Spawn `lead-programmer` via Task using gate **LP-CODE-REVIEW** (`refs/director-gates.md (bundled with this skill)`).
