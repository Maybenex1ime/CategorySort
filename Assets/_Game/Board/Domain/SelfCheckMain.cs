...
static class BoardSelfCheckMain
{
    static int Main(string[] args)
    {
        try
        {
            ...
            // nên đường dẫn cố định là thư mục Resources duy nhất chứa nó.
            string artDir = Path.Combine("Assets", "_Game", "Content", "Resources", "Art");
